...
class XYMultiFitEnsembleException(FitEnsembleException):
    pass


class XYMultiFitEnsemble(FitEnsembleBase):
    """
    Object for generating ensembles of fits to *xy* pseudo-data generated according to the
    specified uncertainty model.

    After constructing an :py:obj:`~kafe2.fit.XYMultiFitEnsemble` object, an error model should be added
    to it. This is done as for :py:obj:`~kafe2.fit.multi.XYMultiFit` objects by using the
    :py:meth:`~kafe2.fit.XYMultiFitEnsemble.add_simple_error` or :py:meth:`~kafe2.fit.XYMultiFitEnsemble.add_matrix_error`
    methods.

    Once an uncertainty model is provided, the fit ensemble can be generated by using the
    :py:meth:`~kafe2.fit.XYMultiFitEnsemble.run` method. This method starts by generating a pseudo-dataset in such a way
    ...
    The ensemble result can be visualized by using the :py:meth:`~kafe2.fit.XYMultiFitEnsemble.plot_results` method.
    ...
    def __init__(self, n_experiments, x_support, model_function, model_parameters,
        ...
        """
        Construct an :py:obj:`~kafe2.fit.XYMultiFitEnsemble` object.
        ...
        # initialize an `XYMultiFit` object for performing the toy fits
        ...
        self._toy_fit = XYMultiFit(xy_data=[self._ref_x_data, self._ref_y_data],
    ...
    # "inherit" docstring
    add_simple_error.__doc__ = XYMultiFit.add_simple_error.__doc__
    ...
    # "inherit" docstring
    add_matrix_error.__doc__ = XYMultiFit.add_matrix_error.__doc__
