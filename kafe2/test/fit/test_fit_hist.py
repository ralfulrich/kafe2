...
class TestHistFitBasicInterface(AbstractTestFit, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._ref_prop_dict = dict(
            parameter_values=np.array(self._ref_initial_pars),  # TODO: fix type
            poi_values=np.array(self._ref_initial_pars),        # TODO: fix type
    ...
    def test_fit_results(self):
        self.run_test_for_all_fits(
            dict(
                self._ref_prop_dict,
                # TODO: fix type
                parameter_values=np.array(self._nominal_fit_result_pars_nll),
                # TODO: fix type
                poi_values=np.array(self._nominal_fit_result_pars_nll),
        ...
        self.run_test_for_all_fits(
            dict(
                self._ref_prop_dict,
                # TODO: fix type
                parameter_values=np.array(self._nominal_fit_result_pars_chi2),
                # TODO: fix type
                poi_values=np.array(self._nominal_fit_result_pars_chi2),
